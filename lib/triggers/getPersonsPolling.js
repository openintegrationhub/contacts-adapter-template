...
async function processTrigger(msg, cfg, snapshot = {}) {
  ...
  const self = this;
  const iamToken = (msg.body.meta && (msg.body.meta !== undefined || msg.body.meta.iamToken !== undefined)) ? msg.body.meta.iamToken : 'iamToken not set yet';
  ...
  async function emitData() {
    ...
    if (process.env.ELASTICIO_COMP_ID !== undefined) {
      ...
      applicationUid = applicationUidResponse.data.applicationUid;
    }
